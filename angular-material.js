  ...
  function advancedDialogOptions($mdDialog, $mdTheming) {
    return {
      template: [
        ...
        '               ng-click="dialog.abort()" class="">',
        '      {{ dialog.cancel }}',
        '    </md-button>',
        '    <md-button ng-click="dialog.hide()" class="md-accent" md-autofocus="dialog.$type!=\'confirm\'">',
        '      {{ dialog.ok }}',
        '    </md-button>',
        '  </md-dialog-actions>',
        '</md-dialog>'
